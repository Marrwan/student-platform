        ...
        <div className="bg-white rounded-xl shadow-sm border border-gray-100 p-8 w-full max-w-2xl">
            ...
            <div className="flex items-start gap-6 mb-8">
                ...
                <div className="flex-1">
                    ...
                    <p className="text-gray-500 mb-1">{user.jobTitle || 'Staff Member'}</p>
            ...
            <div className="grid grid-cols-2 gap-y-6 gap-x-12 border-t border-gray-100 pt-6 mb-8">
                <div>
                    <p className="text-xs text-gray-400 uppercase tracking-wider mb-1">Department</p>
                    <p className="text-gray-800 font-medium">{user.department?.name || 'Not Assigned'}</p>
                </div>
                <div className="text-right">
                    <p className="text-xs text-gray-400 uppercase tracking-wider mb-1">Location</p>
                    <p className="text-gray-800 font-medium">{user.location || 'Remote'}</p>
                </div>
                <div>
                    <p className="text-xs text-gray-400 uppercase tracking-wider mb-1">Supervisor</p>
                    <p className="text-gray-800 font-medium">
                        {user.manager ? `${user.manager.firstName} ${user.manager.lastName}` : 'None'}
                    </p>
                </div>
                <div className="text-right">
                    <p className="text-xs text-gray-400 uppercase tracking-wider mb-1">Work Anniversary</p>
                    <p className="text-gray-800 font-medium">
            ...
            <div className="flex items-center justify-between pt-6 border-t border-gray-100">
                <p className="text-blue-600 font-bold">{completionPercentage}% Profile Completed</p>
