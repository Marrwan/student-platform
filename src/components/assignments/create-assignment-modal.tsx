  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      const assignmentData = {
        ...
        sampleOutputUrl: formData.sampleOutputType === 'url' ? formData.sampleOutputUrl : null,
        sampleOutputCode: formData.sampleOutputType === 'code' ? formData.sampleOutputCode : null,
